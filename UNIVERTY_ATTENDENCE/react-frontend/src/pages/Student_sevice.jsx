          ...
          {activeTab === 'attendance' && (
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 3fr) 1fr', gap: '30px' }}>
              ...
              <div id="printable-report">
                <div style={{ display: 'grid', gridTemplateColumns: '100px 1fr 280px', alignItems: 'center', gap: '0', borderBottom: '2.5px solid #872e22', padding: '2px 0', margin: '0 0 8px 0', minHeight: '80px' }}>
                  {/* Left: Logo */}
                  <div style={{ textAlign: 'left' }}>
                    <img src="/IMAGES/logo.webp" alt="University Logo" style={{ width: '50px', height: '50px', objectFit: 'contain' }} />
                  </div>

                  {/* Center: University Name & Legal */}
                  <div style={{ textAlign: 'center' }}>
                    <h1 style={{ color: '#872e22', margin: '0', fontSize: '15px', fontWeight: 'bold', fontFamily: 'serif', letterSpacing: '0.5px' }}>ਮਹਾਰਾਜਾ ਰਣਜੀਤ ਸਿੰਘ ਪੰਜਾਬ ਟੈਕਨੀਕਲ ਯੂਨੀਵਰਸਿਟੀ, ਬਠਿੰਡਾ</h1>
                    <h2 style={{ color: '#872e22', margin: '-4px 0 0 0', fontSize: '15px', fontWeight: 'bold', fontFamily: 'sans-serif', letterSpacing: '0.2px' }}>Maharaja Ranjit Singh Punjab Technical University, BATHINDA</h2>
                    <p style={{ margin: '2px 0 0 0', fontSize: '10px', color: '#5c677d', fontWeight: 'bold' }}>
                      (A State University Established By Govt. of Punjab vide Punjab Act No. 5 <br></br>of 2015 and Approved Under Section 2(f) & 12 (B) of UGC)
                    </p>
                  </div>

                  {/* Right: Contact Info */}
                  <div style={{ textAlign: 'right', fontSize: '10px', color: '#333', lineWeight: '1.1' }}>
                    <p style={{ margin: '0', whiteSpace: 'nowrap' }}>
                      <strong style={{ color: '#872e22' }}>Contact Us:</strong> <span style={{ color: '#4a5568' }}>+91-1644-239205</span>
                    </p>
                    <p style={{ margin: '0', whiteSpace: 'nowrap' }}>
                      <strong style={{ color: '#872e22' }}>Email:</strong> <span style={{ color: '#4a5568' }}>info@mrsptu.ac.in</span>
                    </p>
                  </div>
                </div>
